...
# 选择参数
from UAV_type.UAV_m105.parameters.param_ABQR_m105_50Hz import A,B,Q,R
# from UAV_type.UAV_m105.parameters.param_ABQR_m105_100Hz import A,B,Q,R

# 选择轨迹
from reference_trajectory.traj_heart_xz import XRef    # xz平面内的心型轨迹
# from reference_trajectory.traj_8 import XRef  # 8字型轨迹
# from reference_trajectory.hover_and_traj_8 import XRef # 先竖直上升，然后8字型轨迹
# from reference_trajectory.traj_8_song import XRef # 宋博的8字型轨迹

# from reference_trajectory.traj_spiral_upward import XRef
# from reference_trajectory.traj_hover1 import XRef
...
class TinyMPC:
    ...
    def main_loop(self):
        ...
        # df_uk_history.to_excel("tinympc_simulate_data/uk_history.xlsx")
